...
const text = {
  ru: {
    ...
    landingDiagnostics: "Журнал запросов",
    landingPrivateNote: "Ролевой доступ",
    landingRuntimeNote: "Публикация instance",
    landingDiagnosticsNote: "Источник ответа и статус",
  ...
  en: {
    ...
    landingDiagnostics: "Request log",
    landingPrivateNote: "Role-based access",
    landingRuntimeNote: "Instance publication",
    landingDiagnosticsNote: "Response source and status",
